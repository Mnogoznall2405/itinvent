...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    """
    help_text = """
🤖 <b>Справка по работе с ботом инвентаризации IT-invent Bot v2.0.1</b>
...
• 🖨️ Замены картриджей (Excel)
• 📦 Установки оборудования (Excel)
• Выбор периода и базы данных
• Отправка на email или в чат

<b>🗄️ Управление базами данных:</b>
• Переключение между базами ITINVENT, ITINVENT2
